...
const fetchSimply1 = async (url, init)=>{
    ...
    if (!res.ok) {
        throw new FetchSimplyError1(`${res.status} '${res.statusText}' received instead of 200-299 range`, res.status, res.statusText);
    }
...
export { FetchSimplyError1 as FetchSimplyError };
